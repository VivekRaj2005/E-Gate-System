...
import SLog from "./Components/Dashboard/Security Log";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/security/log/login" element={<SLog securityData={securityData} setSecurityData={setSecurityData}/>} />
